...
class GeoPqrForm extends BasePqrForm {
    ...
    protected $description_fieldmap = array('description','address','claim_address','damage_type_by_citizen', 'damage_width_by_citizen', 'damage_length_by_citizen', 'damage_deep_by_citizen','damage_element_by_citizen','geo_point');
